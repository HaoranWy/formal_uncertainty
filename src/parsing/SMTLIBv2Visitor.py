...
class SMTLIBv2Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SMTLIBv2Parser#start_.
    def visitStart_(self, ctx:SMTLIBv2Parser.Start_Context):
    ...
    def visitQual_identifer(self, ctx:SMTLIBv2Parser.Qual_identiferContext):
        return self.visitChildren(ctx)
